            ...
            <div class="row g-0">
                <div class="col-md-6 border-right p-5">
                    <div class="text-center order-details">
                        <div class="d-flex justify-content-center mb-5 flex-column align-items-center"> <span class="check1"><i class="bi bi-bag-check-fill"></i></span> <span class="font-weight-bold">Order Confirmed</span> <small class="mt-2">Your Order will go to you soon</small> <a href="#" class="text-decoration-none invoice-link">View Invoice</a> </div> <button class="btn btn-primary btn-block order-button">Go to your Order</button><br>
                ...
                <div class="col-md-6 background-muted">
                    <div class="p-3 border-bottom">
                        <div class="d-flex justify-content-between align-items-center"> <span><i class="bi bi-clock-o text-muted"></i> 3 days delivery</span> <span><i class="bi bi-refresh text-muted"></i> 2 Max Revisions</span> </div>
                        <div class="mt-3">
                            <h6 class="mb-0">Coconut Milk, Lavender & Lemongrass Scalp Mask (Plant Based)</h6> <span class="d-block mb-0">Includes: Coconut Milk</span> <small>Min: 1 item</small>
                            <div class="d-flex flex-column mt-3"> <small><i class="bi bi-check text-muted"></i>Lorem ipsum</small> <small><i class="bi bi-check text-muted"></i> Lorem ipsum</small> </div>
                        </div>
                    </div>
