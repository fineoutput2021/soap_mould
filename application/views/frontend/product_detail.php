...
<div class="swiper-button-prev"></div> -->
                        ...
                        <div class="col-md-6">
                            <div class="product p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="hover-green"><a href="#" title="Compare now" class="green"><i
                                                    class="bi bi-compass-fill px-2"></i>Compare now</a></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="hover-green"><a href="#" title="Add to Wishlist" class="green"><i
                                                    class="bi bi-heart-half px-2"></i>Add to Wishlist</a></div>
                                    </div>
                                </div>
                                <div class="row mt-3">
